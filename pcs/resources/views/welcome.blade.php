        ...
        <div class="project-carousel owl-carousel">
            <div class="singel-project-item">
                ...
                <h4 class="sub-title">Service</h4>
                    ...
                    <a href="{{asset('img/services/healthcare-environmental-services.jpg')}}" data-rel="lightcase:myCollection" class="project-icon">
            ...
            <div class="singel-project-item">
                ...
                <h4 class="sub-title">Service</h4>
                    ...
                    <a href="img/services/office-building-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <h4 class="sub-title">Service</h4>
                    ...
                    <a href="img/services/event-center-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    ...
                    <a href="img/services/hospitality-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    <h4 class="sub-title">Service</h4>
                    <h2 class="project-title">RESIDENTIAL FLOOR CLEANING</h2>
                    <a href="img/services/residential-floor-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    ...
                    <a href="img/services/religious-building-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    ...
                    <a href="img/services/government-building-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    ...
                    <a href="img/services/recreation-and-shopping-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="singel-project-item">
                ...
                <div class="project-content">
                    ...
                    <a href="img/services/banks-and-financial-institutions-cleaning.jpg" data-rel="lightcase:myCollection" class="project-icon">
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            </div>
                        ...
                        <div class="section-heading section-heading-2 mb-85 pr-35">
                            ...
                            <div class="content mt-35">
                                <p>We invest highly in our exceptional cleaning staff which is returned by loyalty,
                                    enthusiasm and the motivation to produce excellent cleaning standards for you, your home and your business.</p>
                            </div>
                        </div>
                        <div class="wcu-box-wrapper mt-none-40">
                            <div class="wcu-box mt-40 d-flex align-items-center">
                                <div class="wcu-content-new">
                                    ...
                                    <p>We’re committed to delivering an excellent client experience from start to finish—from our helpful customer service staff and quick
                                         response to our 24/7 availability, quality commercial cleaning service, and client communication app.</p>
                                </div>
                            </div>
                            <div class="wcu-box mt-40 d-flex align-items-center">
                                <div class="wcu-content-new">
                                    <h4 class="wcu-title">Trusted cleaners</h4>
                                    <p>All our cleaners are friendly, experienced and fully trained in cleaning, health, safety, security and so on. We also screen our cleaners to make sure they meet our strict employment, safety and security standards. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-12">
                    <div class="testimonial-carousel owl-carousel">
                        <div class="single-testimonial">
                            <div class="thumb">
                                <img src="assets/images/testimonial/testiimonial-1-author-3.png" alt="" width="70%">
                                <span class="icon"><i class="fal fa-check"></i></span>
                            </div>
                            <div class="content">
                                <p>“ Wonderful experience using PCSCleanup Services; I am extremely happy with the service they provide.
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="content">
                                <p>“ This proprietorship really uses elbow grease when cleaning…they do so much more than simple surface cleaning. Moreover, PCS tries to satisfy each particular individual need and/or desire.”</p>
                                <div class="testimonial-meta mt-20">
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="content">
                                <p>“It was wonderful to have our new condo cleaned so thoroughly by truly hard-working and personable professionals.”</p>
                                <div class="testimonial-meta mt-20">
